 ...
 * </pre>
 */
public class MultiQueryFetchStrategyOld implements ExecutionStrategy<List<Map<String, Object>>> {

    private static final Logger logger = Logger.getLogger(MultiQueryFetchStrategyOld.class.getName());
     ...
     *                                  configured
     */
    public MultiQueryFetchStrategyOld(Class<?> projectionClass) {
     ...
     *                                  configured
     */
    public MultiQueryFetchStrategyOld(Class<?> projectionClass, InstanceResolver instanceResolver) {
