 ...
 * </p>
 * <p>
 * {@code PropertyReference} only contains the logical definition of the
 * property (type, supported operators).
 * Each adapter is responsible for interpreting this interface and building the
 * appropriate conditions.
 * This distinction offers great flexibility, allowing for example a single
 * property reference
 * to correspond to multiple fields or complex conditions.
 * </p>
 * <p>
 * For validation of operators and values, use the
 * {@link OperatorValidationUtils} utility class.
 * </p>
 * <p>
 * <b>Usage example:</b>
 * </p>
...
public interface PropertyReference {
     ...
     *
     * @return the Java class representing the property type (e.g., String.class,
     *         Integer.class)
     */
    Class<?> getType();

    /**
     * Returns the unmodifiable collection of default operators supported by this
     * property.
     *
     * @return an immutable {@link Set} of default operators supported by the
     *         property
     */
